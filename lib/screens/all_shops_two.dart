...
import '../colors.dart';
import '../data/stores_handler.dart';
import 'all_shops_two/element_shop_grid.dart';
import 'all_shops_two/element_shop_list.dart';
import 'cart.dart';

class AllShopsTwo extends StatefulWidget {
  final ShopCategory category;
  const AllShopsTwo({Key? key,required this.category}) : super(key: key);

  @override
  State<AllShopsTwo> createState() => _AllShopsTwoState();
}

class _AllShopsTwoState extends State<AllShopsTwo> {
  bool isList = true;
  @override
