...
import 'package:zone_final/screens/track_order.dart';

import '../../colors.dart';
import '../../data/all_products_data.dart';

class CustomOrderCardCurrent extends StatelessWidget {
  final Map<String,dynamic> order;
  const CustomOrderCardCurrent({Key? key,required this.order}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          order['state']==0?'Being prepared'
                              :order['state']==1?'Ready for shipping'
                          :'On the way',
                          style:  TextStyle(
                            color: order['state']==0?Colors.orange
                                :order['state']==1?Colors.blue
                                :Colors.green,
                            fontSize: 16,
                          ),
                        ),
                      ...
                      Row(
                        children: [
                          ...
                          TextButton(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.follow_the_signs,color: zoneColor1,),
                                Padding(
